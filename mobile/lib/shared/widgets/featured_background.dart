...
/// снимка (в момента: брънч постер, брънчът свършва в 16:00) - след този
/// час фонът просто спира да се показва, без да се трие файлът/кода.
...
final DateTime _featuredBackgroundExpiresAt = DateTime(2026, 8, 2, 16, 0);
